...
<section class="py-12 bg-gray-50">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Temukan informasi terbaru dan berita penting dari kami</p>
        </div>
                    ...
                    <div class="flex-1 p-6 md:p-8 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="flex items-center mb-3 flex-wrap">
                                ...
                                <span class="ml-3 bg-rose-500 text-white px-3 py-1 rounded-full text-xs font-medium">
                                    {{ $info->category }}
                                </span>
                            </div>
